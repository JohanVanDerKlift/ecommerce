...
INSERT INTO local_user (email, first_name, last_name, password, username, email_verified)
    VALUES ('UserA@junit.com', 'UserA-FirstName', 'UserA-LastName', '$2a$10$Ut4HU4sDNVmc/OGDTtZDVexaw3KVW.b8hemPQzyNpr.ugQhbqRuuq', 'UserA', true),
           ('UserB@junit.com', 'UserB-FirstName', 'UserB-LastName', '$2a$10$kz3AjiDIJ0cIAM9cT34tD.fEgJHE57ysOeLHGFRM/o6lq7wlNIu3S', 'UserB', false),
           ('UserC@junit.com', 'UserC-FirstName', 'UserC-LastName', '$2y$10$KJ7..f6P1X8/jET8z193le52BCzVuFqY43FrAeje6ZNhjA6u0bF9q', 'UserC', false);
...
INSERT INTO web_orders (address_id, user_id)
VALUES (1, 1)
     , (1, 1)
     , (1, 1)
     , (2, 3)
